...
$(document).ready(function() {
    ...
    cart.get(function() {console.log(cart.products)});
    cart.clear(function() {console.log(cart.products)});
    // For cart-display.html
    $('button#remove').on('click', function() {
        var product_pk = this.value;
        cart.remove(product_pk, function() {console.log(cart.products)});
   });
    ...
    $('button#buy').on('click', function() {
        ...
        cart.set(product_pk, quant,function() {console.log(cart.products)});
   });
});
