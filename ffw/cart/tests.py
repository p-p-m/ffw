...
class CartViewTest(TestCase):
    ...
    def setUp(self):
        ...
        for code, price in ['code-1', self.price_1], ['code-2', self.price_2], ['code-3', self.price_3], ['code-4', self.price_4]:
            product_conf = factory(ProductConfiguration, product=product, code=code, price_uah=price)
    ...
    def test_cart(self):
        ...
        def _total_data(quant_1=0, quant_2=0, quant_3=0, quant_4=0):
           ...
           self.expected_count = self.expected_quant_1 + self.expected_quant_2 + self.expected_quant_3 + self.expected_quant_4
        ...
        def cart_add_test():
            ...
            quant_3 = 3
            quant_4 = 1
            self.product_dict = {self.product_pk_1: quant_1, self.product_pk_2: quant_2, self.product_pk_3: quant_3, self.product_pk_4: quant_4 }
        ...
        def cart_remove_test():
            ...
            self.expected_products = {self.product_pk_3: self.expected_quant_3, self.product_pk_4: self.expected_quant_4}

            self._calc('product_pk_list', [self.product_pk_1, self.product_pk_2 ])
    ...
    def _calc(self, key, value):
        ...
        self._compare_cart() #control by comparing session['cart'] with self.expected_cart
