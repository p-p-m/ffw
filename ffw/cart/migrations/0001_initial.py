        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contacts', models.CharField(max_length=255,
                                              verbose_name='Additional communication', blank=True)),
                ('total',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(
                    verbose_name='Total', max_digits=9, decimal_places=2)),
                ('order', models.ForeignKey(related_name='products',
                                            verbose_name='Order', to='cart.Order')),
                ('product', models.ForeignKey(related_name='ordered_product',
                                              verbose_name='Product', to='products.ProductConfiguration')),
            ],
            options={
