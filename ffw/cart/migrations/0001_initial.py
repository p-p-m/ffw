    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=125, verbose_name='E-mail', blank=True)),
                ('phone', models.CharField(max_length=125, verbose_name='Phone')),
                ('contacts', models.TextField(verbose_name='Additional contacts', blank=True)),
                ...
                ('is_resolved', models.BooleanField(default=False, verbose_name='Is order resolved')),
            ],
            options={
                'verbose_name': 'Order',
